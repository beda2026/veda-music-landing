  ...
  return (
    <main className="mx-auto w-full max-w-[1000px] px-4 py-10 sm:px-6 lg:px-10">
      <article className="panel rounded-3xl p-6 sm:p-8">
        ...
        <Link href="/artistas" className="mt-6 inline-block rounded-full border border-[#f5b21b]/60 px-4 py-2 text-sm font-semibold text-zinc-100 transition hover:border-[#ef1f2d]">← Volver a Artistas</Link>
      </article>
    </main>
  );
}
