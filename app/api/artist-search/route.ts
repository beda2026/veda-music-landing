...
export async function GET(request: NextRequest) {
  ...
  const conversationMode: VedaConversationMode = modeParam === 'artist_lead' || modeParam === 'business_lead' || modeParam === 'promotion_lead' || modeParam === 'artist_promo_services' || modeParam === 'package_services' ? modeParam : 'neutral';
