  ...
  return (
    <>
      <section id="contacto" className="space-y-4">
        <div className="panel relative rounded-2xl border border-[#f5b21b]/25 bg-[#121212]/52 backdrop-blur-md p-5 sm:p-6">
      ...
      {isServicesModalOpen ? (
        <div className="fixed inset-0 z-[110] flex items-center justify-center bg-black/58 px-4 py-6 backdrop-blur-sm" onClick={closeServicesModal}>
          <div role="dialog" aria-modal="true" aria-labelledby="servicios-modal-title" className="panel relative w-full max-w-[980px] max-h-[85vh] overflow-y-auto rounded-2xl border border-[#f5b21b]/30 bg-[#090909]/68 backdrop-blur-lg p-5 sm:p-7" onClick={(event) => event.stopPropagation()}>
