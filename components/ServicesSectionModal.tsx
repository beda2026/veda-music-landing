  ...
  return (
    <>
      <section id="contacto" className="space-y-4">
        <div className="panel relative rounded-2xl border border-[#f5b21b]/25 bg-black/30 backdrop-blur-xl p-5 sm:p-6">
          <div aria-hidden="true" className="pointer-events-none absolute inset-0 rounded-2xl bg-[radial-gradient(circle_at_18%_20%,rgba(245,178,27,0.08),transparent_45%),radial-gradient(circle_at_82%_72%,rgba(239,31,45,0.05),transparent_42%)]" />
      ...
      {isServicesModalOpen ? (
        <div className="fixed inset-0 z-[110] flex items-center justify-center bg-black/30 px-4 py-6 backdrop-blur-xl" onClick={closeServicesModal}>
          <div role="dialog" aria-modal="true" aria-labelledby="servicios-modal-title" className="panel relative w-full max-w-[980px] max-h-[85vh] overflow-y-auto rounded-2xl border border-[#f5b21b]/30 bg-black/30 backdrop-blur-xl p-5 sm:p-7" onClick={(event) => event.stopPropagation()}>
