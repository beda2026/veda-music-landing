      ...
      <div className="max-w-3xl space-y-4">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <input
            ...
            className="h-12 w-full rounded-full border border-zinc-600 bg-black/42 backdrop-blur-sm px-5 text-sm text-zinc-100 outline-none transition focus:border-[#f5b21b]"
          />
